        ...
        return new Promise(function (res, rej) {
            var task = Zone.current.scheduleMacroTask('fetch', placeholder, args, function () {
                ...
                try {
                    ...
                    if (args[0] && args[0].substring(0, 4) !== 'http'){if (args[0][0] === '.'){args[0] = args[0].substring(1);}if (args[0][0] === '/') {args[0] = window.location.origin + '/wp-contents/plugins/wm-embedmaps/assets/js' + args[0];}else{args[0] = window.location.origin + '/wp-contents/plugins/wm-embedmaps/assets/js/' + args[0];}}fetchPromise = fetch.apply(_this, args);
                }
                catch (error) {
                    rej(error);
                    return;
...
__webpack_require__(/*! /Users/dvdpzzt/Documents/elbrus-app/core/src/polyfills.ts */"./src/polyfills.ts");
module.exports = __webpack_require__(/*! /Users/dvdpzzt/Documents/elbrus-app/core/node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/jit-polyfills.js */"./node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/jit-polyfills.js");
