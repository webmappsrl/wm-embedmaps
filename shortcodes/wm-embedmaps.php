...
function wm_render_embedmaps_shortcode($atts)
{
    ...
    extract(shortcode_atts(array(
        ...
        "hide_fullscreen_taxonomy_filters" => "",
        "fullscreen_on_text" => "",
        "fullscreen_off_text" => "",
        "features_ids" => "",
        "show_related_pois" => "",
    ...
    if ($hide_fullscreen_taxonomy_filters != '') {
        $htmlAttributes .= " hideFullscreenTaxonomyFilters=\"$hide_fullscreen_taxonomy_filters\"";
    }
    ...
    if ($force_zoom_to_feature_in_details != '') {
        $htmlAttributes .= " forceZoomToFeatureInDetails=\"$force_zoom_to_feature_in_details\"";
    }
