...
| `poi_click_action`                 | `string`  | `undefined` | Set the action to perform when selecting a poi in the map.                                                                                                                                                                                   |                                                              |
| `track_click_action`               | `string`  | `undefined` | Set the action to perform when selecting a track in the map.                                                                                                                                                                                 |                                                              |
| `route_click_action`               | `string`  | `undefined` | Set the action to perform when selecting a route in the map.                                                                                                                                                                                 |                                                              |
